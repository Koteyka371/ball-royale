...
def invoke_jules_brainstorm(token):
    ...
    brainstorm_prompt = (
        "Brainstorm at least 5 new creative and highly specific technical/feature ideas for Ball Royale. "
        "Each idea MUST be written as a separate JSON file in the 'ideas/' directory (e.g. 'ideas/idea_magnetic_hazard.json'). "
        "Format for each file: {\"title\": \"...\", \"description\": \"...\"}. "
        "Keep filenames unique using descriptive snake_case names.\n\n"
        "GUIDELINES FOR TECHNICAL BRAINSTORMING AREAS:\n"
        "1. ADVANCED AI & DECISION MAKING:\n"
        "   - Pathfinding & steering behaviors (A* navigation around hazards, obstacles avoidance, flocking, group flanking).\n"
        "   - Memory models (remembering past attackers, revenge targeting, coordination of focus fire).\n"
        "   - Advanced math for threat/opportunity assessment (weight functions, target priority, danger coefficients).\n"
        "2. PHYSICS, HAZARDS & ENVIRONMENT:\n"
        "   - Dynamic environmental forces (wind zones, gravity wells, portals, ice/lava friction, conveyer belts).\n"
        "   - Interactive obstacles (moving walls, rotating hazards, closing gates, hazard pits).\n"
        "   - Ball physics (elastic collisions, mass differences, recoil, impulse-based dashes).\n"
        "3. GAME SYSTEMS & BUFFS/DEBUFFS:\n"
        "   - Status effect framework (poison damage-over-time, freeze/slow, stun, shield, rage damage boost).\n"
        "   - Class-specific resources (cooldowns, energy, mana, shields, charge skills).\n"
        "   - New game modes (Team Deathmatch, VIP protection, King of the Hill, Infection, 1v1 Tournaments).\n"
        "4. GRAPHICS, SPECTATOR SPORT & REPLAYS:\n"
        "   - Camera scoring algorithms (cinematic tracking of epic collisions, group fights, low-health duels).\n"
        "   - Event-driven live text commentary generation (e.g., generating emotional statements about kills, double-kills, or narrow escapes).\n"
        "   - Analytics & visualization (heatmaps of battles, death points, booster pickup densities).\n"
        "5. EVOLUTIONARY & TRAINING SYSTEM:\n"
        "   - Neural network training optimizations (genetic algorithms, crossover methods, dynamic fitness evaluation, weight mutations).\n\n"
        "Read docs/game_design.md and agent_tasks.json to avoid duplication. Ensure each description includes a brief TECHNICAL implementation outline (e.g., which equations, vectors, or structures to modify in src/ai/ or src/arena/)."
    )
