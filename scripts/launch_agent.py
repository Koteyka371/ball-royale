...
def invoke_jules(task_id, area, prompt, branch_name, token):
    ...
    full_prompt = (
        ...
        f"11. IDEAS INBOX (STRICT HIGH-BAR): Do NOT generate trivial or minor ideas. Generate a new idea ONLY IF it represents a CRITICAL bugfix or HIGH-IMPACT core mechanic improvement (maximum 1 idea per task). If no critical/high-impact idea is needed, leave the ideas/ directory empty.\n"
