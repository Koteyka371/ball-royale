...
def test_disco_floor_mode():
    ...
    try:
        ...
        assert abs(balls[0].speed - 270.0) < 0.1 or abs(balls[0].speed - 180.0) < 0.1
        assert abs(balls[0].stamina - 70.0) < 0.1
        assert abs(balls[0].hp - 100.0) < 0.1

        assert abs(balls[1].speed - 90.0) < 0.1 or abs(balls[1].speed - 60.0) < 0.1
        ...
        assert abs(balls[0].speed - 90.0) < 0.1 or abs(balls[0].speed - 60.0) < 0.1
        assert abs(balls[0].hp - (100.0 - 20.0 * 0.2)) < 0.1

        assert abs(balls[1].speed - 270.0) < 0.1 or abs(balls[1].speed - 180.0) < 0.1
