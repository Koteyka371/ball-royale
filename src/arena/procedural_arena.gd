...
class TargetWeakArena extends ProceduralArena:
	func generate() -> void:
		...
		# TL to Center
		corridors.append(ProceduralArena.Corridor.new(200.0, 300.0, 50.0, cy - 250.0 - 300.0))
		corridors.append(ProceduralArena.Corridor.new(200.0, cy - 250.0, cx - 250.0 - 200.0, 50.0))

		# TR to Center
		corridors.append(ProceduralArena.Corridor.new(w - 250.0, 300.0, 50.0, cy - 250.0 - 300.0))
		corridors.append(ProceduralArena.Corridor.new(cx + 250.0, cy - 250.0, w - 200.0 - (cx + 250.0), 50.0))

		# BL to Center
		corridors.append(ProceduralArena.Corridor.new(200.0, cy + 250.0, 50.0, h - 300.0 - (cy + 250.0)))
		corridors.append(ProceduralArena.Corridor.new(200.0, cy + 200.0, cx - 250.0 - 200.0, 50.0))

		# BR to Center
		corridors.append(ProceduralArena.Corridor.new(w - 250.0, cy + 250.0, 50.0, h - 300.0 - (cy + 250.0)))
		corridors.append(ProceduralArena.Corridor.new(cx + 250.0, cy + 200.0, w - 200.0 - (cx + 250.0), 50.0))

		# 1 central hazard
		hazards.append(ProceduralArena.Hazard.new(0, cx, cy, 50.0, "spikes", 10.0))
