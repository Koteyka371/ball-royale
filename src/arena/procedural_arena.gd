    ...
    if current_tick != last_tick:
        ...
        if safe_zone_radius > 0.0:
            ...
            if current_tick % 300 == 0:
                ...
                var item_kinds = ["deployable_slow_bomb", "healing_spring", "damage_link", "emp_burst", "nemesis_booster", "stamina_booster", "kinetic_booster", "vision_booster", "reverse_gravity_booster", "grapple_booster", "material_magnet_booster", "shrink_beam_attachment", "mirage_booster", "heroism_booster", "echolocation_booster", "orbital_emp_strike_item", "sticky_bomb_booster", "fire_sticky_bomb_booster", "phantom_artifact_item", "blood_pact_artifact_item", "aura_overcharge_booster", "contract_item"]
