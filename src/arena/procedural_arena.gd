...
class TargetWeakArena extends ProceduralArena:
    func generate():
        ...
        corridors.append(ProceduralArena.Corridor.new(100.0, 200.0, 50.0, cy - 600.0))
        corridors.append(ProceduralArena.Corridor.new(100.0, cy - 400.0, cx - 500.0, 50.0))

        corridors.append(ProceduralArena.Corridor.new(w - 150.0, 200.0, 50.0, cy - 600.0))
        corridors.append(ProceduralArena.Corridor.new(cx + 400.0, cy - 400.0, w - cx - 550.0, 50.0))

        corridors.append(ProceduralArena.Corridor.new(100.0, cy + 400.0, 50.0, h - cy - 600.0))
        corridors.append(ProceduralArena.Corridor.new(100.0, cy + 350.0, cx - 500.0, 50.0))

        corridors.append(ProceduralArena.Corridor.new(w - 150.0, cy + 400.0, 50.0, h - cy - 600.0))
        corridors.append(ProceduralArena.Corridor.new(cx + 400.0, cy + 350.0, w - cx - 550.0, 50.0))

        hazards.append(ProceduralArena.Hazard.new(0, cx - 200.0, cy - 200.0, 40.0, "lava", 20.0))
        hazards.append(ProceduralArena.Hazard.new(1, cx + 200.0, cy - 200.0, 40.0, "spikes", 15.0))
        hazards.append(ProceduralArena.Hazard.new(2, cx - 200.0, cy + 200.0, 40.0, "spikes", 15.0))
