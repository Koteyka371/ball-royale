    ...
    if current_tick != last_tick:
        ...
        if safe_zone_radius > 0.0:
            ...
            if current_tick % 300 == 0:
                ...
                var item_kinds = ["healing_spring", "damage_link", "emp_burst", "nemesis_booster", "stamina_booster", "vision_booster", "reverse_gravity_booster", "material_magnet_booster", "mirage_booster", "orbital_emp_strike_item"]
