...
def test_hazard_generation():
    ...
    for hazard in arena.hazards:
        assert hazard.kind in ["ice_patch", "ice_patch", "ice_patch", "tornado_warning", "spikes", "lava", "fake_booster", "decoy_item", "breakable_wall", "link_booster", "stamina_booster", "silence_booster", "freeze_booster", "poison_cloud", "proximity_trap", "explosive_barrel", "healing_spring", "trap", "spinning_laser", "laser_wall", "meteor", "conveyor_belt", "gravity_well", "reverse_gravity", "repulsion_field", "black_hole", "portal", "teleporter", "one_way_teleporter", "swap_portal", "placeable_trap_item", "portal_gun_item", "flare", "crater", "bumper", "tornado", "lightning_storm", "hidden_trap", "hidden_mine", "lightning_strike", "switch", "magnet", "temporal_rift", "fire_zone", "quicksand", "sinkhole", "massive_sinkhole", "damage_link", "weather_booster", "magnet_booster", "fire_ring", "wormhole", "clone_booster", "stealth_zone", "invert_booster", "stamina_drain_zone", "tether_trap", "reverse_gravity_booster", "anchor_booster", "anomaly_zone", "slip_zone", "tall_grass", "loadout_fragment", "vortex"]
        assert hazard.radius > 0
        assert hazard.damage > 0 or hazard.kind in ["healing_spring", "placeable_trap_item", "portal_gun_item", "decoy_item", "breakable_wall", "portal", "teleporter", "one_way_teleporter", "swap_portal", "flare", "crater", "bumper", "temporal_rift", "link_booster", "stamina_booster", "silence_booster", "freeze_booster", "drone_item", "stealth_drone_item", "shadow_booster", "switch", "magnet", "temporal_rift", "quicksand", "sinkhole", "massive_sinkhole", "damage_link", "weather_booster", "magnet_booster", "fire_ring", "wormhole", "clone_booster", "stealth_zone", "invert_booster", "stamina_drain_zone", "tether_trap", "reverse_gravity_booster", "anchor_booster", "anomaly_zone", "slip_zone", "tall_grass", "loadout_fragment", "vortex"]
