...
def test_hazard_generation():
    ...
    for hazard in arena.hazards:
        assert hazard.kind in ["spikes", "lava", "fake_booster", "decoy_item", "breakable_wall", "link_booster", "stamina_booster", "silence_booster", "poison_cloud", "proximity_trap", "explosive_barrel", "healing_spring", "trap", "spinning_laser", "laser_wall", "meteor", "conveyor_belt", "gravity_well", "reverse_gravity", "black_hole", "portal", "teleporter", "swap_portal", "placeable_trap_item", "portal_gun_item", "flare", "crater", "bumper", "tornado", "lightning_storm", "hidden_trap", "lightning_strike", "switch", "magnet", "temporal_rift", "fire_zone", "quicksand", "sinkhole", "damage_link", "weather_booster", "magnet_booster", "fire_ring", "wormhole", "clone_booster"]
        assert hazard.radius > 0
        assert hazard.damage > 0 or hazard.kind in ["healing_spring", "placeable_trap_item", "portal_gun_item", "decoy_item", "breakable_wall", "portal", "teleporter", "swap_portal", "flare", "crater", "bumper", "temporal_rift", "link_booster", "stamina_booster", "silence_booster", "drone_item", "stealth_drone_item", "shadow_booster", "switch", "magnet", "temporal_rift", "quicksand", "sinkhole", "damage_link", "weather_booster", "magnet_booster", "fire_ring", "wormhole", "clone_booster"]
