...
def test_hazard_generation():
    ...
    for hazard in arena.hazards:
        assert hazard.kind in ["spikes", "lava", "fake_booster", "decoy_item", "link_booster", "stamina_booster", "silence_booster", "poison_cloud", "proximity_trap", "explosive_barrel", "healing_spring", "trap", "spinning_laser", "laser_wall", "meteor", "conveyor_belt", "gravity_well", "black_hole", "portal", "teleporter", "swap_portal", "placeable_trap_item", "flare", "crater", "bumper", "tornado", "hidden_trap", "lightning_strike", "switch", "magnet", "temporal_rift", "fire_zone", "quicksand", "sinkhole", "damage_link", "weather_booster", "magnet_booster", "fire_ring"]
