...
class BallGeneticsArena extends ProceduralArena:
	func generate() -> void:
		...
		rooms.append(ProceduralArena.Room.new(cx + 200, cy - 100, 200, 200))

		corridors.append(ProceduralArena.Corridor.new(cx - 250, cy - 50, 50, 100))
		corridors.append(ProceduralArena.Corridor.new(cx + 200, cy - 50, 50, 100))
