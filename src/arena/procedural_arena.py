...
class ProceduralArena:
    ...
    def generate(self):
        ...
        for i in range(num_hazards):
            kind = random.choice(["deployable_proximity_mud_puddle", "deployable_mud_puddle", "deployable_acid_puddle", "deployable_shockwave_mine", "deployable_slow_bomb", "shrink_ray_trap", "spikes", "lava", "whirlpool", "fake_booster", "swap_trap", "shuffle_trap", "slow_motion_trap", "decoy_item", "link_booster", "stamina_booster", "kinetic_booster", "weather_booster", "poison_cloud", "proximity_trap", "spinning_laser", "healing_spring", "grave_robber_shovel", "temporal_rift", "temporal_bubble", "bumper", "tornado", "lightning_storm", "hidden_trap", "hidden_mine", "silence_booster", "freeze_booster", "switch", "magnet", "quicksand", "magnet_booster", "material_magnet_booster", "breakable_wall", "portal_gun_item", "wormhole", "clone_booster", "flashbang_booster", "stealth_zone", "invert_booster", "reverse_gravity_booster", "grapple_booster", "stamina_drain_zone", "tether_trap", "slip_zone", "tall_grass", "mud_puddle", "vortex", "frictionless_zone", "molten_rock", "singularity", "ice_patches", "shuffle_booster", "forecast_booster", "exploding_booster", "debuff_booster", "cursed_booster", "half_reflect_shield_booster", "hookshot_booster", "chain_lightning_strike", "clone_spawner", "skill_reroll_booster", "friendly_fire_reflect_booster", "damage_reflection_booster", "chain_reaction_bumper", "time_dilation_bumper", "mirage_booster", "heroism_booster", "position_swap_booster", "phase_booster", "orbital_emp_strike_item", "jump_pad", "phantom_artifact_item", "blood_pact_artifact_item", "aura_overcharge_booster", "contract_item"])
            if kind == "switch":
                radius = 20.0
                damage = 0.0
            ...
            if kind == "jump_pad":
                ...
                damage = 0.0
                target_x = random.uniform(0.0, self.width)
                target_y = random.uniform(0.0, self.height)
            elif kind == "whirlpool":
                ...
                radius = 15.0
                damage = 0.0
            elif kind in ["stamina_booster", "kinetic_booster", "weather_booster", "magnet_booster", "material_magnet_booster", "clone_booster", "flashbang_booster", "invert_booster", "freeze_booster", "reverse_gravity_booster", "grapple_booster", "shuffle_booster", "forecast_booster", "exploding_booster", "debuff_booster", "cursed_booster", "half_reflect_shield_booster", "hookshot_booster", "skill_reroll_booster", "friendly_fire_reflect_booster", "damage_reflection_booster", "mirage_booster", "heroism_booster", "position_swap_booster", "phase_booster", "orbital_emp_strike_item", "phantom_artifact_item", "blood_pact_artifact_item", "aura_overcharge_booster", "contract_item"]:
                radius = 15.0
                damage = 0.0
                ...
                radius = random.uniform(40.0, 80.0)
                damage = 0.0
            elif kind in ["bumper", "time_dilation_bumper", "pinball_bumper", "stationary_bumper"]:
                radius = random.uniform(30.0, 60.0)
                damage = 0.0
                ...
                if random.random() < 0.4:
                    powerups = ["heal", "speed", "shield", "stamina", "cursed", "heat_shield", "cryo_heal"]
            ...
            new_hazard = Hazard(id=i, x=hx, y=hy, radius=radius, kind=kind, damage=damage)
            if kind == "jump_pad":
                new_hazard.target_x = target_x
                new_hazard.target_y = target_y
        ...
        num_quantum = max(1, self.num_rooms // 3)
        ...
        if current_tick != self.last_tick:
            ...
            if self.safe_zone_radius > 0.0:
                ...
                if current_tick % 300 == 0:
                    ...
                    item_kind = random.choice(["deployable_proximity_mud_puddle", "deployable_mud_puddle", "deployable_acid_puddle", "deployable_shockwave_mine", "deployable_slow_bomb", "healing_spring", "damage_link", "emp_burst", "nemesis_booster", "stamina_booster", "kinetic_booster", "vision_booster", "reverse_gravity_booster", "grapple_booster", "material_magnet_booster", "silencer_attachment", "extended_mag_attachment", "modified_scope_attachment", "laser_sight_attachment", "shrink_beam_attachment", "mirage_booster", "heroism_booster", "position_swap_booster", "phase_booster", "orbital_emp_strike_item", "sticky_bomb_booster", "fire_sticky_bomb_booster", "phantom_artifact_item", "blood_pact_artifact_item", "aura_overcharge_booster", "contract_item"])
            ...
            for h in self.hazards:
                ...
                if getattr(h, "kind", "") == "flare":
                    ...
                    if hasattr(h, "duration"):
                        ...
                        if h.duration <= 0:
                            h.active = False
                elif getattr(h, "kind", "") in ["bumper", "pinball_bumper", "stationary_bumper"]:
                    ...
                    if hasattr(h, "duration"):
                        ...
                        if h.duration <= 0:
                            ...
                            import random
                            num_debris_hazards = random.randint(3, 5)
