                ...
                if getattr(h, "kind", "") == "flare":
                    ...
                    if hasattr(h, "duration"):
                        ...
                        if h.duration <= 0:
                            ...
                            fire_zone_id = 7000 + len(self.hazards) + len(new_craters) + random.randint(0, 1000)
                            fire_zone = Hazard(id=fire_zone_id, x=h.x, y=h.y, radius=h.radius * 1.5, kind="fire_zone", damage=20.0)
