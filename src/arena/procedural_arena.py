    ...
    def generate(self):
        ...
        for i in range(num_hazards):
            ...
            if kind == "jump_pad":
                ...
                radius = 15.0
                damage = 0.0
            elif kind in ["stamina_booster", "weather_booster", "magnet_booster", "material_magnet_booster", "clone_booster", "flashbang_booster", "invert_booster", "freeze_booster", "reverse_gravity_booster", "grapple_booster", "shuffle_booster", "forecast_booster", "exploding_booster", "debuff_booster", "cursed_booster", "half_reflect_shield_booster", "hookshot_booster", "skill_reroll_booster", "friendly_fire_reflect_booster", "damage_reflection_booster", "mirage_booster", "heroism_booster", "position_swap_booster", "phase_booster", "orbital_emp_strike_item", "floating_debris", "phantom_artifact_item", "blood_pact_artifact_item", "aura_overcharge_booster"]:
                radius = 15.0
                damage = 0.0
