        ...
        if current_tick != self.last_tick:
            ...
            if self.safe_zone_radius > 0.0:
                ...
                if current_tick % 300 == 0:
                    ...
                    item_kind = random.choice(["grapple_trap", "deployable_proximity_mud_puddle", "deployable_mud_puddle", "deployable_acid_puddle", "healing_spring", "damage_link", "emp_burst", "nemesis_booster", "stamina_booster", "vision_booster", "reverse_gravity_booster", "material_magnet_booster", "silencer_attachment", "extended_mag_attachment", "modified_scope_attachment", "laser_sight_attachment", "mirage_booster", "position_swap_booster", "phase_booster"])
