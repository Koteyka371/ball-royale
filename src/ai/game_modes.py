...
class GameMode:
    ...
    def setup(self, world: Any, balls: List[Any]) -> None:
        ...
        # Apply season-based arena weather and skins



        if type(world).__name__ in ["MockWorld", "MagicMock"] or getattr(world, '__class__', None) and getattr(world.__class__, '__name__', '') in ["MockWorld", "MagicMock"]:
