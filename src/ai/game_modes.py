    ...
    def tick(self, world: Any, balls: List[Any], delta: float = 0.016) -> None:
        ...
        if self.supply_drop_timer >= 15.0:
            ...
            if hasattr(world, "boosters"):
                ...
                booster_kinds = ["speed_booster", "damage_booster", "hp_booster", "vision_booster", "stamina_booster", "pull_booster", "nemesis_booster", "nemesis_compass_item", "shadow_booster", "weather_scanner_item", "aura_booster", "emp_immunity_booster", "cleanse_booster", "fake_booster", "cursed_booster", "shield_booster"]
