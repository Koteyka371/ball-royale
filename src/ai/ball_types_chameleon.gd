class_name Chameleon extends RefCounted

const BALL_TYPE = "chameleon"
const HP = 90.0
const SPEED = 7.0
const DAMAGE = 25.0
const RADIUS = 8.0
...
const COLOR = Color(0.0, 0.0, 0.0) # black
const SKILL = "blend"
...
var attack_range: float = 21.0
var personality = null
var team: String = ""
var speed_multiplier: float = 1.0
var blend_amount: float = 0.0
var invisible_to_minimap: bool = false
