...
def test_scout_priorities():
    ...
    assert action_weak in ("chase", "attack", "use_skill", "flank")
    ...
    assert action_strong in ("collect_booster", "attack", "use_skill")
...
def test_tank_priorities():
    ...
    action = layer.choose_action(perception, "calm")
    assert action in ("defend", "collect_booster", "use_skill")
...
def test_healer_priorities():
    ...
    action = layer.choose_action(perception, "calm")
    assert action in ("defend", "collect_booster", "use_skill") # Healer's defend translates to healing/protecting
