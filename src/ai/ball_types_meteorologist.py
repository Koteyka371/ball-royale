"""
Auto-generated ball type: Meteorologist

Meteorologist ball has a built-in forecast_booster effect, which gives
it advanced warning of weather changes in ExtremeWeatherMode.
"""

from ai.personality import Personality

class Meteorologist:
    BALL_TYPE = "meteorologist"
    HP = 90
    SPEED = 8.5
    DAMAGE = 10
    RADIUS = 10
    ...
    def __init__(self, ball_id: int, x: float = 0.0, y: float = 0.0):
        ...
        self.forecast_booster_active = True # Permanent innate ability
    ...
    def use_skill(self) -> bool:
        if self.skill_timer <= 0:
            ...
            # Refresh forecast booster active state just in case
