"""
Auto-generated ball type: Engineer
Support type that can deploy autonomous turrets that shoot enemies.
"""
...
class Engineer:
    ...
    def __init__(self, ball_id: int, x: float = 0.0, y: float = 0.0):
        import random
        self.SKILL = random.choice(['deploy_turret', 'turret_overload'])
        self.id = ball_id
