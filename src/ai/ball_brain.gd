...
func _init(ball_ref, world_ref):
    ...
    # Instance the perception system using load() instead of static reference if it's external
    # We can use the Perception class_name
    self.perception_system = Perception.new(self.ball, self.world)
