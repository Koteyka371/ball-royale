"""
Quantum Tangler ball type. Uses dash and leaves behind quantum tangles.
"""

import math
from ai.personality import Personality

class QuantumTangler:
    BALL_TYPE = "quantum_tangler"
    HP = 100
    SPEED = 2.5
    DAMAGE = 10
    RADIUS = 10
    ...
    def __init__(self, ball_id: int, x: float = 0.0, y: float = 0.0):
        ...
        self.dash_range_mult = 1.2
        self.leave_tangle_chance = 0.33
