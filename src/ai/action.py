                    ...
                    if hazard.kind == "explosive_barrel":
                        ...
                        if not hasattr(hazard, "last_updated_tick") or hazard.last_updated_tick != current_tick:
                            ...
                            if not hasattr(hazard, "vx"):
                                ...
                                hazard.vx = _rnd.uniform(-100.0, 100.0) if hazard.kind == "tornado" else _rnd.uniform(-10.0, 10.0)
                                hazard.vy = _rnd.uniform(-100.0, 100.0) if hazard.kind == "tornado" else _rnd.uniform(-10.0, 10.0)
