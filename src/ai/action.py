            ...
            if dist <= ball_radius + 10:
                if getattr(nearest, "kind", None) == "drone_item":
                    ...
                    for i in range(3):
                        ...
                        angle = (2 * math.pi / 3) * i + random.uniform(-0.2, 0.2)
                        speed = getattr(self.ball, "speed", 5.0) * 1.5
                        holo.vx = math.cos(angle) * speed
                        holo.vy = math.sin(angle) * speed
