"""
Auto-generated ball type: Distract Drone
A drone that specifically distracts and taunts guard-type enemies.
"""
from ai.personality import Personality

class DistractDrone:
    BALL_TYPE = "distract_drone"
    HP = 120
    SPEED = 4.5
    DAMAGE = 5
    RADIUS = 10
    ...
    def __init__(self, ball_id: int, x: float = 0.0, y: float = 0.0):
        ...
        self.personality = Personality("evasive")
