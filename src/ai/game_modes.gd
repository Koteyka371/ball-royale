    ...
    func tick(world, balls: Array, delta: float = 0.016) -> void:
        ...
        if supply_drop_timer >= 15.0:
            ...
            if "boosters" in world:
                ...
                rng.randomize()
                var booster_kinds = ["speed_booster", "damage_booster", "hp_booster", "vision_booster", "stamina_booster", "pull_booster", "nemesis_booster", "shadow_booster", "weather_scanner_item", "aura_booster"]
