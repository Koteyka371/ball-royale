	...
	func tick(world, balls: Array, delta: float = 0.016) -> void:
		...
		if supply_drop_timer >= 15.0:
			...
			if "boosters" in world:
				...
				rng.randomize()
				var booster_kinds = ["damage_link_booster", "speed_booster", "hologram_booster", "damage_booster", "hp_booster", "vision_booster", "stamina_booster", "pull_booster", "nemesis_booster", "nemesis_compass_item", "shadow_booster", "stealth_booster", "weather_scanner_item", "aura_booster", "hazard_immunity_booster", "chain_immunity_booster", "emp_immunity_booster", "cleanse_booster", "fake_booster", "dummy_item", "cursed_booster", "grapple_booster", "time_rewind_booster", "time_stop_booster", "instant_rewind_booster", "charging_shockwave_shield_booster", "shield_booster", "half_reflect_shield_booster", "projectile_reflect_booster", "rearm_token", "gravity_well_booster"]
			...
			if b_alive and b_type == "loot_goblin":
				...
				if hp <= 0:
					...
					if boosters_array != null:
						var booster_kinds = ["damage_booster", "speed_booster", "charging_shockwave_shield_booster", "shield_booster", "hp_booster", "gravity_well_booster"]
						for i in range(3):
...
class PhysicsAnomalyEventMode extends GameMode:
	var event_timer = 0.0
	var event_active = false
	var event_duration = 0.0
	var cx = 500.0
...
class ItemMorphMode extends GameMode:
	...
	var rng = RandomNumberGenerator.new()
	var booster_kinds = ["damage_link_booster", "speed_booster", "hologram_booster", "damage_booster", "hp_booster", "vision_booster", "stamina_booster", "pull_booster", "nemesis_booster", "nemesis_compass_item", "shadow_booster", "stealth_booster", "weather_scanner_item", "aura_booster", "hazard_immunity_booster", "chain_immunity_booster", "emp_immunity_booster", "cleanse_booster", "fake_booster", "dummy_item", "cursed_booster", "grapple_booster", "time_rewind_booster", "time_stop_booster", "instant_rewind_booster", "half_reflect_shield_booster", "projectile_reflect_booster", "rearm_token", "gravity_well_booster"]
