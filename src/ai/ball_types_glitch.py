...
class Glitch:
    ...
    def use_skill(self) -> bool:
        if self.skill_timer <= 0:
            ...
            # Logic for reversing vx/vy is handled in action.py / action.gd
            return True
        return False
