class PreGameLobby:
    ...
    def select_trap_variant(self, ball_id, variant):
        if variant in ["normal", "poison", "stun", "ricochet", "emp", "hologram", "blindness", "shriek", "decoy", "blackout", "mine", "elemental_mine", "time_dilation_mine", "warp", "warp_mine", "clone", "tar", "link", "repulsion", "swap", "reversal"]:
    ...
    def apply_random_loadout(self, ball_id, profile):
        ...
        trap_variants = ["normal", "poison", "stun", "ricochet", "emp", "hologram", "blindness", "shriek", "chain_lightning", "decoy", "blackout", "mine", "elemental_mine", "warp", "warp_mine", "siphon", "clone", "tar", "link", "web", "sticky_bomb", "swap", "reversal"]
