class PreGameLobby:
    ...
    def apply_random_loadout(self, ball_id, profile):
        ...
        trap_variants = ["normal", "poison", "stun", "ricochet", "emp", "hologram", "blindness", "chain_lightning", "lightning_parasite", "decoy", "mine", "elemental_mine", "warp", "siphon", "clone", "tar", "link"]
