class PreGameLobby:
    ...
    def select_trap_variant(self, ball_id, variant):
        if variant in ["normal", "poison", "stun", "ricochet", "emp", "hologram", "blindness", "decoy", "mine", "clone", "tar"]:
    ...
    def apply_random_loadout(self, ball_id, profile):
        ...
        trap_variants = ["normal", "poison", "stun", "ricochet", "emp", "hologram", "blindness", "chain_lightning", "decoy", "mine", "warp", "siphon", "clone", "tar"]
