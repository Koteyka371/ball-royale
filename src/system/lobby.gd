...
func get_mutator_options() -> Array:
    return ["low_gravity", "double_damage", "high_speed", "vampirism", "global_hp", "global_cooldown", "invisible_hazards", "kinetic_ghost", "bouncy_walls", "bouncy_payload", "sudden_death_event", "crimson_fog"]
