...
func select_trap_variant(ball_id: int, variant: String) -> void:
    if variant in ["normal", "poison", "stun", "ricochet", "emp", "hologram", "chain_lightning", "decoy", "blackout", "blindness", "shriek", "mine", "elemental_mine", "time_dilation_mine", "warp", "warp_mine", "clone", "tar", "link", "repulsion", "swap", "reversal"]:
...
func apply_random_loadout(ball_id: int, profile: ProfileManager) -> bool:
    ...
    var trap_variants = ["normal", "poison", "stun", "ricochet", "emp", "hologram", "chain_lightning", "decoy", "blackout", "mine", "elemental_mine", "warp", "warp_mine", "siphon", "clone", "tar", "link", "web", "sticky_bomb", "swap", "reversal"]
