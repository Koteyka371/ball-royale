...
func select_trap_variant(ball_id: int, variant: String) -> void:
    if variant in ["normal", "poison", "stun", "ricochet", "emp", "hologram", "chain_lightning", "decoy", "blackout", "blindness", "shriek", "mine", "elemental_mine", "time_dilation_mine", "warp", "warp_mine", "clone", "tar", "link", "repulsion", "swap", "reversal", "water_blast"]:
...
func get_mutator_options() -> Array:
    return ["mini_black_hole_spawner", "gravity_inverter_hazard", "low_gravity", "double_damage", "high_speed", "vampirism", "global_hp", "global_cooldown", "invisible_hazards", "kinetic_ghost", "bouncy_walls", "bouncy_payload", "sudden_death_event", "shifting_mirror_walls", "stamina_vampire", "frictionless_arena_modifier", "low_hp_swap_mutator", "invert_controls_mutator", "clutch_comeback"]
...
func apply_random_loadout(ball_id: int, profile: ProfileManager) -> bool:
    ...
    var trap_variants = ["normal", "poison", "stun", "ricochet", "emp", "hologram", "chain_lightning", "decoy", "blackout", "mine", "elemental_mine", "warp", "warp_mine", "siphon", "clone", "tar", "link", "web", "sticky_bomb", "swap", "reversal", "water_blast"]
