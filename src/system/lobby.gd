...
func select_trap_variant(ball_id: int, variant: String) -> void:
    if variant in ["normal", "poison", "stun", "ricochet", "emp", "hologram", "chain_lightning", "lightning_parasite", "decoy", "blindness", "mine", "elemental_mine", "warp", "clone", "tar", "link"]:
...
func apply_random_loadout(ball_id: int, profile: ProfileManager) -> bool:
    ...
    var trap_variants = ["normal", "poison", "stun", "ricochet", "emp", "hologram", "chain_lightning", "lightning_parasite", "decoy", "mine", "elemental_mine", "warp", "siphon", "clone", "tar", "link"]
