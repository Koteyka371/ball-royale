...
# Also check for b["vx"] if it's a dict, sometimes python/gdscript translations use dictionaries.
# I will just replace the exact lines found below pull_strength in the CenterBlackHoleMode logic.
