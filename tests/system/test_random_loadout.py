...
def test_apply_random_loadout(temp_profile_file):
    ...
    assert lobby.get_trap_variant(1) in ["normal", "poison", "stun", "ricochet", "emp", "hologram", "blindness", "chain_lightning", "decoy", "mine", "warp", "siphon", "clone", "tar", "link", "elemental_mine"]
