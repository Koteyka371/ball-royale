...
def test_apply_random_loadout(temp_profile_file):
    ...
    assert lobby.get_trap_variant(1) in ["normal", "poison", "stun", "ricochet", "emp", "hologram", "blindness", "shriek", "chain_lightning", "decoy", "mine", "elemental_mine", "warp", "siphon", "clone", "tar", "link", "web", "sticky_bomb"]
