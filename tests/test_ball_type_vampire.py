"""
Auto-generated tests for: Vampire
"""
...
def test_vampire_initialization():
    ball = Vampire(ball_id=1, x=100, y=200)
    assert ball.id == 1
    assert ball.hp == 120
...
def test_vampire_hp_percent():
    ball = Vampire(ball_id=1)
    ball.hp = 120 / 2
