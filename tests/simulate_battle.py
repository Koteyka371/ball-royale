...
BALL_TYPES = {
    ...
    "vampire": {"hp": 80, "speed": 3.2, "damage": 20, "radius": 10,
                "perception_radius": 280, "aggression": 0.7, "color": "darkred",
                "skill": "lifesteal", "skill_cooldown": 4.0},
    "paladin": {"hp": 180, "speed": 1.5, "damage": 12, "radius": 16,
                "perception_radius": 220, "aggression": 0.4, "color": "lightyellow",
                "skill": "holy_aura", "skill_cooldown": 7.0},
    "necromancer": {"hp": 70, "speed": 2.5, "damage": 15, "radius": 9,
                    "perception_radius": 300, "aggression": 0.5, "color": "darkgray",
                    "skill": "raise_dead", "skill_cooldown": 8.0},
    "mage": {"hp": 60, "speed": 2.0, "damage": 30, "radius": 11,
             "perception_radius": 350, "aggression": 0.6, "color": "blue",
             "skill": "fireball", "skill_cooldown": 5.0},
    "archer": {"hp": 75, "speed": 3.5, "damage": 25, "radius": 9,
               "perception_radius": 400, "aggression": 0.6, "color": "green",
               "skill": "multishot", "skill_cooldown": 4.5},
    "monk": {"hp": 110, "speed": 3.0, "damage": 18, "radius": 12,
             "perception_radius": 260, "aggression": 0.5, "color": "orange",
             "skill": "chi_blast", "skill_cooldown": 3.5},
    "druid": {"hp": 130, "speed": 2.2, "damage": 14, "radius": 14,
              "perception_radius": 280, "aggression": 0.3, "color": "darkgreen",
              "skill": "entangle", "skill_cooldown": 6.0},
    "thief": {"hp": 65, "speed": 4.2, "damage": 22, "radius": 8,
              "perception_radius": 320, "aggression": 0.8, "color": "black",
              "skill": "backstab", "skill_cooldown": 3.0},
    "shaman": {"hp": 90, "speed": 2.4, "damage": 16, "radius": 13,
               "perception_radius": 290, "aggression": 0.4, "color": "brown",
               "skill": "totem", "skill_cooldown": 7.5},
    "bard": {"hp": 85, "speed": 2.8, "damage": 10, "radius": 10,
             "perception_radius": 300, "aggression": 0.2, "color": "pink",
             "skill": "song_of_courage", "skill_cooldown": 5.5},
    "engineer": {"hp": 100, "speed": 2.0, "damage": 15, "radius": 12,
                 "perception_radius": 250, "aggression": 0.5, "color": "silver",
                 "skill": "turret", "skill_cooldown": 8.0},
    "cyborg": {"hp": 140, "speed": 2.5, "damage": 20, "radius": 15,
               "perception_radius": 270, "aggression": 0.6, "color": "cyan",
               "skill": "laser", "skill_cooldown": 6.5},
    "pirate": {"hp": 105, "speed": 2.8, "damage": 22, "radius": 11,
               "perception_radius": 280, "aggression": 0.7, "color": "gold",
               "skill": "cannonball", "skill_cooldown": 5.0},
    ...
    "healer": {"hp": 120, "speed": 2.2, "damage": 5, "radius": 10,
               ...
               "skill": "heal_ally", "skill_cooldown": 2.5},
