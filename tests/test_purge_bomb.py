...
class MockWorld:
    ...
    def _deal_damage(self, attacker, target, base_dmg, skill_name=""):
        pass
...
def test_throw_purge_bomb_creation():
    ...
    def mock_get_enemies():
        return [b for b in world.balls if b.team != ball1.team and b.alive]
    action._get_enemies = mock_get_enemies

    action.ball.skill = "throw_purge_bomb"
